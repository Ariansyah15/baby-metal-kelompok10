...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="<?= base_url(); ?>">Toko BabyMetal</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <?php if (!empty($this->session->userdata('email'))) { ?>
                        <a class="nav-item nav-link" href="<?= base_url('order'); ?>">Keranjang <b>(<?= $temp; ?> Item)</b></a>
                    ...
                    <?php } else { ?>
                        <a class="nav-item nav-link" href="<?= base_url('autentifikasi/registrasi'); ?>"><i class="fas fw fa-login"></i> Daftar</a>
